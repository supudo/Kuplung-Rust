...
pub const WINDOW_WIDTH_VIEWER: f32 = 300.0;
pub const WINDOW_HEIGHT_VIEWER: f32 = 300.0;
pub const WINDOW_WIDTH_FRACTALS: f32 = 300.0;
pub const WINDOW_HEIGHT_FRACTALS: f32 = 300.0;

pub const COMPONENT_LOG_WIDTH: f32 = 600.0;
